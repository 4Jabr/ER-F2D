...
def main(args):
    ...
    test_dataset = concatenate_subfolders(join(args.data_path, args.data_folder),
                                       ...
                                       gt_path,
                                       rgb_path,
                                       1,  # sequence_length as positional argument
                                       transform=CenterCrop(224),
                                       #Compose([RandomRotationFlip(0.05, 0.05, 0.05),PixelShiftTransform(10,0.05),ZoomTransform(1.2,0.05),CenterCrop(224)]),#CenterCrop(224),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_to_model', type=str,
                        ...
                        default='')
    parser.add_argument('--data_path', default = "/home/mdl/awb5924/ER-F2D/", type=str, help="data folder path")
